...
// Temporary logging to help debug deployed environment values.
// NOTE: This prints presence/boolean for the client id (not the secret) and the callback URL.
console.log('Google OAuth env -> CLIENT_ID set:', !!GOOGLE_CLIENT_ID, ' CALLBACK_URL:', GOOGLE_CALLBACK_URL);
...
if (!GOOGLE_CLIENT_ID || !GOOGLE_CLIENT_SECRET || !GOOGLE_CALLBACK_URL) {
  ...
  console.log('GoogleStrategy registered. Using callbackURL:', GOOGLE_CALLBACK_URL);
}
